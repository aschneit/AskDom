...
Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])( () => {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])('.abv-form').append("<input type='text' class='abv-input'></input>");
  Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])('.abv-form').append("<input type='submit' value='search'></button>");
  rootEl.append("<ul class ='abv-beer-list'>");
  let beerList = [];
  Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])('.abv-form').on('submit', (e) =>{
    e.preventDefault();
    const abvVal = Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])('.abv-input').val();
    __WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */].ajax({
      ...
      success(data) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])('.abv-beer-list').find('li').remove();
        for (let i=0; i < arr.length; i++) {
          beerList.push(arr[i].name);
        }
        beerList.forEach(beer =>{
          Object(__WEBPACK_IMPORTED_MODULE_0__main_js__["a" /* $l */])('.abv-beer-list').append(`<li>${beer}</li>`);
        });
      },
      error() {
